...
export default function Overlay({ scrollYProgress }: { scrollYProgress: MotionValue<number> }) {
  ...
  const x2 = useTransform(scrollYProgress, [0.25, 0.35, 0.45, 0.55], [-100, 0, 0, -100]);
  ...
  return (
    <div className="absolute inset-0 z-10 w-full h-full max-w-7xl mx-auto px-6 md:px-12 pointer-events-none">
      ...
      >
        <h1 className="text-6xl md:text-9xl font-semibold tracking-tighter text-white drop-shadow-2xl">
